...
// classe clone da classe de demo, mas sem mostrar a senha para o jogador
...
public class TelaJogo {
    ...
    public TelaJogo(JFrame win, PinoColorido[] senha) { // parametros com a janela gerada e referencia a senha
        this.win = win;
    ...
    public void criaJanelaJogo(){
        ...
        //painelDeConteudo.add(linha9);     linha do texto da solucao colocada em comentario para nao adicionar a solucao para a janela
        //painelDeConteudo.add(linha10);    linha do arranjo da solucao colocada em comentario para nao adicionar a solucao para a janela
